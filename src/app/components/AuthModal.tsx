...
function friendlyError(err: any): string {
  ...
  if (msg.includes('too many') || msg.includes('rate')) {
    return 'Too many attempts — Supabase has temporarily blocked this. Click "Use a code" below to sign in without a password.';
  }
  if (msg.includes('invalid login') || msg.includes('invalid credentials')) {
    return 'Incorrect password. Use "Use a code" if you signed up via email code and never set a password.';
  }
  if (msg.includes('email not confirmed')) return 'Email not verified. Check your inbox for the code.';
